...
| `canada-pr-pathways-weekly` | content | Monday 05:00 America/Toronto | `0 10 * * 1` | `.github/workflows/digest-canada-pr-pathways-weekly.yml` | Weekly scan of Canadian Permanent Residency pathway updates across federal Express Entry and provincial/PNP routes, prioritized for an Ontario-based software/em |
